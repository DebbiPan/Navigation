...
var x = localStorage.getItem('x'); //获取localString中的x

var xObject = JSON.parse(x); //将x转化成对象
...
window.onbeforeunload = function () {
  var string = JSON.stringify(hasMap); //将hasMap的数据变成string

  localStorage.setItem('x', string); //将string存在x里面
};

$(document).on('keypress', function (e) {
  var key = e.key; //const {key} = e.key可简写
...
//# sourceMappingURL=main.f2af4aa2.js.map